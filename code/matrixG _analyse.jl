...
begin
	Y, H = steepest_descent(G, F, maxiter=1000_000)
end

# ╔═╡ a38d3425-b6be-47c3-9388-6d939479a0ab
length(H)

# ╔═╡ 9d079c93-9498-4486-b44a-65b61ba9d114
begin
	y_num = [u_0]
	for y in Y[end]
		push!(y_num, y)
...
begin
	plot(x_0:0.001:x_M, u.(x_0:0.001:x_M), label = "analyt", title = "M = $M")
	scatter!(x_0:Δx:x_M, y_num, label = "num", markersize = 0.5)
end
...
manifest_format = "2.0"
project_hash = "cba88749410685dab8eb0fa2164e432bd6d46979"
